...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden border-t border-[oklch(0.9_0.02_250)] bg-black/10">
      ...
      <div className="relative mx-auto px-10 mx-2 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1.3fr_1fr_1fr]">
          ...
          <div>
            ...
            <motion.a
              ...
              target="_blank"
              whileHover={{ x: 4 }}
              className="mt-6 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-[oklch(0.32_0.11_250)] transition-colors hover:bg-[oklch(0.42_0.13_250)] hover:text-white"
            >
              <Send size={16} />
              Наш Telegram
            </motion.a>
        ...
        {/* Розділювач */}
        <div className="my-10 h-px w-full bg-[var(--accent)]" />
